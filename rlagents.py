...
class SimpleAgent(object):
    ...
    def manhattan(self):
        return abs(self.game.food['x']-self.game.snake_body['x']) + abs(self.game.food['y']-self.game.snake_body['y'])
    ...
    def choose_action(self):
        ...
        if (np.random.uniform() > EPSILON):
            ...
            action = self.looup_dict(state).argmax()
        q_array = self.looup_dict(state) #self.q_dict[state][action]
    ...
    def get_reward(self, terminated):
        ...
        if terminated:
            ...
            R = (new_manhattan - self.prev_mahattan) + 10 * (new_len - self.prev_len)
    ...
    def play(self):
        ...
        for epoch in range(10):
            ...
            while not terminated:
                ...
                self.prev_mahattan = self.mahattan()
